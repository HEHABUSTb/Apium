...
print("Text of the button: ", button_enter_some_value.text)
print("Text of the button: ", button_enter_some_value.get_attribute("text"))

print("Content Description: ", button_enter_some_value.get_attribute("content-desc"))
